...
const FEATURED_MOVIE = {
  ...
  title: "Don't Move",
  thumbnail:
    "https://occ-0-8407-2219.1.nflxso.net/dnm/api/v6/E8vDc_W8CLv7-yMQu8KMEC7Rrr8/AAAABWsjI5VID3ChnY1bGlkeXfdS0qY19EszZmC9vOQjb72s7hyKAfD-5Yy1OAceR9CfLqyxRMWPu15X6_zAf5ELM4gLbXcJL_2B2e8E.jpg?r=bb0",
    ...
    <TabScreenWrapper isActive={isActive} slideDirection={slideDirection}>
      <View style={styles.container}>
        ...
        >
          ...
          {movies.map((row) =>
            row.rowTitle === "Mobile Games" ? (
              <GameList key={row.rowTitle} {...row} />
            ) : (
